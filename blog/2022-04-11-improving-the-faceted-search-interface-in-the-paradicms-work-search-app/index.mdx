...
* increasing the fraction of screen real estate dedicated to the most important part of the interface, the faceted search results
* emphasizing the most important parts of each result (image, title) and de-emphasizing others
...
Filters can be shown inline, as on the Texas Fashion Collection site, or in a drawer, as on the Museum at FIT's collection interface. Putting filters in a drawer seem to have become the more popular choice in recent years.
