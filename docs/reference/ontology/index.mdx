...
import conceptProperties from "./properties/conceptProperties";
import NamespacesTable from "./_namespaces-table.md"
import PropertiesTable from "@site/src/components/PropertiesTable";
import dateTimeDescriptionProperties from "./properties/dateTimeDescriptionProperties";
import imageProperties from "./properties/imageProperties";
import licenseProperties from "./properties/licenseProperties";
import locationProperties from "./properties/locationProperties";
import organizationProperties from "./properties/organizationProperties";
import personProperties from "./properties/personProperties";
import propertyProperties from "./properties/propertyProperties";
import propertyGroupProperties from "./properties/propertyGroupProperties";
import rightsStatementProperties from "./properties/rightsStatementProperties";
...
The Paradicms ontology directly expresses the [Paradicms data model](/docs/introduction/data-model) as an RDF ontology. The ontology is relatively flat, with few properties requiring nested data structures like lists and sub-objects. That makes it easier to convert data from spreadsheets and other tabular sources into RDF.

### Vocabularies

The Paradicms ontology reuses different RDF-based vocabularies for describing the properties of works, collections, images, agents, et al. These vocabularies include:
...
VRA Core 4.0 [has been translated to an RDF ontology](http://purl.org/vra/) for use in Linked Data systems. The Paradicms ontology reuses a number of properties from the VRA Core RDF ontology in order to describe aspects of cultural heritage artifacts, including a `Work`'s `culturalContext`, `material`, and `technique`.

The Paradicms ontology defines custom properties where absolutely necessary. For example, configuration files for the static site generation system rely on a bespoke RDF vocabulary that is highly specific to Paradicms.
...
<PropertiesTable properties={collectionProperties} />
...
<PropertiesTable properties={conceptProperties} />
...
<PropertiesTable properties={dateTimeDescriptionProperties} />
...
<PropertiesTable properties={imageProperties} />
...
<PropertiesTable properties={licenseProperties} />
...
<PropertiesTable properties={locationProperties} />
...
<PropertiesTable properties={organizationProperties} />
...
<PropertiesTable properties={personProperties} />
...
<PropertiesTable properties={propertyProperties} />
...
<PropertiesTable properties={propertyGroupProperties} />
...
<PropertiesTable properties={rightsStatementProperties} />
...
<PropertiesTable properties={textProperties} />
...
<PropertiesTable properties={workProperties} />
