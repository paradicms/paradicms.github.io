...
![Screenshot of timeline app](timeline.png)

The `timeline` app displays a timeline of `Events`s in a dataset, with one additional detail page per `Event`.

- [Demo site](https://dressdiscover.github.io/exhibitions/)
- <GoogleSheetsGitHubTemplateRepositoryLink>
    GitHub repository
  </GoogleSheetsGitHubTemplateRepositoryLink>
...
- [Demo site](https://dressdiscover.github.io/costume-core-template/)
- <AirtableGitHubTemplateRepositoryLink>
    GitHub repository
  </AirtableGitHubTemplateRepositoryLink>
...
Features are defined by `Property` implementations in the [Paradicms logical data models](/docs/reference/logical-data-models), such as `RdfProperty`. Feature sets are defined by `PropertyGroup`'s. The choices available for each feature correspond to `Concept`'s in the range of the feature's `Property`.

- [Demo site](https://dressdiscover.github.io/worksheet/)
