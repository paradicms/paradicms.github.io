...
Follow [these instructions](https://docs.github.com/en/repositories/creating-and-managing-repositories/creating-a-repository-from-a-template) on creating a GitHub repository from a template, using <DirectoryGitHubTemplateRepositoryLink>this template repository</DirectoryGitHubTemplateRepositoryLink>.
