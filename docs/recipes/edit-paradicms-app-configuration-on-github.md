...
![Screenshot of viewing the app configuration in GitHub](img/edit-paradicms-app-configuration-on-github/view.png)

### Click the edit (pencil) button

![Screenshot of the edit button in GitHub](img/github-edit-file-button.png)

### Edit the app configuration as needed

![Screenshot of editing the app configuration in GitHub](img/edit-paradicms-app-configuration-on-github/edit.png)
